...
link: 
	g++ -I"C:\SFML-2.6.2\include" .\main.o  .\good_guy.o .\tit_for_tat.o .\random.o -o main.exe -L"C:\SFML-2.6.2\lib" -lmingw32 -lsfml-graphics -lsfml-window -lsfml-system -lsfml-main
